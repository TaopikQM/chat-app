...
const ChatPage = () => {
  // const [currentUser] = useState(""); // Gantilah dengan ID pengguna yang sesuai
  // const [chatWith] = useState("user2"); // ID pengguna tujuan
  const [currentUser] = useState("Nabilla"); // Gantilah dengan ID pengguna yang sesuai
  const [chatWith] = useState("Budi");
