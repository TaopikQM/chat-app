...
// };
    ...
    // };
        ...
        //     const closePopup = () => setPopupFile(null);
                        ...
                        <div className="fixed inset-0 bg-black bg-opacity-70 flex justify-center items-center z-50">
                            ...
                            <div className="relative p-4">
                                ...
                                {popupFile.endsWith('.jpg') || popupFile.endsWith('.png') || popupFile.endsWith('.gif') ? (
                                    ...
                                    <iframe src={popupFile} className="max-w-full max-h-full rounded-lg border border-gray-300" title="Document" />
                                ) : popupFile.endsWith('.doc') || popupFile.endsWith('.docx') ? (
                                    <iframe src={`https://docs.google.com/gview?url=${popupFile}&embedded=true`} className="max-w-full max-h-full rounded-lg border border-gray-300" title="Document" />
                                ) : (
                                    <span className="text-center text-gray-500">Format tidak didukung</span>
                                )}
                            </div>
                        </div>
                    )}
