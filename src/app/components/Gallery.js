...
//             const storedFiles = localStorage.getItem('galleryFiles');
            
//             if (storedFiles) {
//                 // If files are in localStorage, use them
//                 const parsedFiles = JSON.parse(storedFiles);
//                 setFiles(parsedFiles);
//                 setFilteredFiles(parsedFiles);

//                 const grouped = parsedFiles.reduce((acc, file) => {
...
//             } else {
//                 // If no files in localStorage, fetch from Firebase
...
//                     localStorage.setItem('galleryFiles', JSON.stringify(fileDetails));
//                 } catch (error) {
...
const Gallery = () => {
    ...
    return (
        <div>
            ...
            <div className="space-y-6">
                         {isLoading
                ? // Jika masih loading, tampilkan skeleton loader
                  Array(3)
                      .fill(0)
                      .map((_, i) => (
...
//     useEffect(() => {
//         const fetchFiles = async () => {
//             // Cek sessionStorage untuk cache
//             const cachedFiles = sessionStorage.getItem("chatFiles");
...
//                 // Cache file details ke sessionStorage
//                 sessionStorage.setItem("chatFiles", JSON.stringify(fileDetails));
...
//         const processFiles = (fileDetails) => {
//             setFiles(fileDetails);
//             setFilteredFiles(fileDetails);
