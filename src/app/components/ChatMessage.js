    ...
    return (
      ...
      <div className={`flex ${isSender ? "justify-end" : "justify-start"}`}>
        <div className="items-start space-x-2">
          ...
          {/* Modal Lightbox */}
          <Modal isOpen={isOpen} onClick={closeModal} onRequestClose={closeModal} className="fixed inset-0 bg-black bg-opacity-75 flex justify-center items-center p-4 z-100">
