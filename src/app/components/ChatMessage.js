          ...
          <div className="flex ">
            {isSender && (
              <div className="relative">
                ...
                {isDropdownOpen && (
                  <div className="absolute buttom-full right-full mb-2 bg-white divide-y divide-gray-100 rounded-lg shadow-sm w-40 dark:bg-gray-500 dark:divide-gray-600 z-10">
            ...
            {!isSender && (
              <div className="relative">
                ...
                {isDropdownOpen && (
                  <div className="absolute buttom-full left-full mb-2 bg-white divide-y divide-gray-100 rounded-lg shadow-sm w-40 dark:bg-gray-500 dark:divide-gray-600 z-10">
