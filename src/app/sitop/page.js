...
// const ChatPage = () => {
//   const [currentUser] = useState("sitop"); // Gantilah dengan ID pengguna yang sesuai
//   const [chatWith] = useState("diah"); // ID pengguna tujuan
//   const [sitop] = useState("sitop"); // ID pengguna tujuan
...
//           const res = await fetch("/api/uploadPhotositop", {
//             method: "POST",
...
const capturePhoto09090 = () => {
  ...
  // ========= FUNGSI CAPTURE FOTO =========
  const capturePhoto22222222 = async (status = "unknown") => {
     if (!photoCaptureEnabled) {
      console.warn("Capture Photo dimatikan");
      return null; // jangan ambil foto
    }
