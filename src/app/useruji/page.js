...
const ChatPage = () => {
  const [currentUser] = useState("useruji"); // Gantilah dengan ID pengguna yang sesuai
  const [chatWith] = useState("useruji2"); // ID pengguna tujuan
  const [topik] = useState("topik11"); // ID pengguna tujuan
