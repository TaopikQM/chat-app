        ...
        <UserProvider>
            <div className="flex">
                ...
                <div
                    ...
                    className="hidden flex-col justify-end py-1 mb-4 space-y-2 bg-white border border-gray-100 rounded-lg shadow-sm dark:border-gray-600 dark:bg-gray-700"
                >
                    <ul className="text-sm text-gray-500 dark:text-gray-300">
                        {["Share", "Print", "Save", "Copy"].map((action) => (
                            <li key={action}>
                                <button
                                    onClick={() => handleMenuAction(action)}
                                    className="flex items-center px-5 py-2 w-full hover:bg-gray-100 dark:hover:bg-gray-600 hover:text-gray-900 dark:hover:text-white"
                                >
